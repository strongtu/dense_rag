...
// Reconcile walks watchDir and compares the files on disk with the store state.
// It returns lists of files that need to be added, removed, or updated.
// It does NOT perform any mutations on the store.
func (s *Store) Reconcile(watchDir string, supportedExts []string) (added, removed, updated []string) {
